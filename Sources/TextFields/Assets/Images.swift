...
public enum SymbolAssets {
  public enum Service {
    public enum Outline {
      ...
      public static let faceID = SymbolAsset(name: "Service/Outline/faceID")
    ...
    public enum Solid {
      public static let star = SymbolAsset(name: "Service/Solid/star")
    }
  }
